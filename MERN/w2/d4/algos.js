...
const wexpected1 = 15; // 30 - 15 = 15

const riverLevels2 = [15, 17, 30, 14, 5, 16, 25, 9, 3];
const wexpected2 = 20; // 25 - 5 = 20

const riverLevels3 = [15, 17, 30, 20, 50, 16, 25, 9, 3];
const wexpected3 = 30; // 50 - 20 = 30

const riverLevels4 = [21, 18, 10, 11, 14, 9, 5, 13, 15, 7, 1, 6, 12, 4];
const wexpected4 = 11; // 12 - 1 = 11
...
function measureWaterLevels(waterLevels) {
    ...
    for (let i = 0; i < waterLevels.length; i++) {
        if (waterLevels[i] > waterLevels[i - 1]) {
            tempRise = tempRise + waterLevels[i+1] 
            largeRise = tempRise - largeRise
        }
    }return largeRise
}
...
//     let setA = numsA.filter(nums => !numsB.includes(nums))
//     let setB = numsB.filter(nums => !numsA.includes(nums))
//     let newArr = []
//     for (let i = 0; i < setA.length; i++) {
//         if (!newArr.includes(setA[i])) {
//             newArr.push(setA[i])
//         }
//     }
//     for (let i = 0; i < setB.length; i++) {
//         if (!newArr.includes(setB[i])) {
//             newArr.push(setB[i])
//         }
//     }
//     return newArr.sort()

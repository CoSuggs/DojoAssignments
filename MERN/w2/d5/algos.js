...
const nums31 = [10, 15, 20, 35, 30];
const sum3 = 5;
const expected3 = [];

// Bonus:
const nums41 = [2, 5, 3, 6, 7, 0, 0, 23, 12];
const sum4 = 16;
const expected4 = [
    [2, 5, 3, 6],
    [3, 6, 7],
...
// Bonus:
const nums51 = [-2, -5, -3, -6, -7, -0, -0, -23, -12];
const sum5 = -16;
const expected5 = [
    [-2, -5, -3, -6],
    [-3, -6, -7],
...
function findConsqSums(nums, targetSum) {
    ...
    let tempArr = []
    let finalArr = []
    for (let start = 0; start < nums.length-start; start++){

...
const threeLevelTree1 = new BinarySearchTree();
...
threeLevelTree1.insertRecursive(10).insertRecursive(5).insertRecursive(2).insertRecursive(8).insertRecursive(15).insertRecursive(20).insertRecursive(13);
threeLevelTree1.print();

...
class MinHeap {
    ...
    //     //if the switched node is greater than left or right node
    //     if(this.heap[parent]>this.heap[left] || this.heap[parent] > this.heap[right]){
    ...
    extract() {
        ...
        while (this.heap.length > pointer * 2 + 1) {

 ...
 * Psuedo code:
 * Take in two arrays
 * assign the first array to be keys
 * assign the second array to be the values
 * code needs to parse through the first array then assign the second array to be the values
